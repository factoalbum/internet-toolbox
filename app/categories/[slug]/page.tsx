        ...
        <div className="mx-auto max-w-5xl">
          <div className="flex min-w-0 items-start justify-between gap-6 border-b-2 border-[#171717] pb-8">
            <div className="min-w-0">
              ...
              <h1 className="mt-3 text-4xl font-black tracking-[-0.04em] md:text-6xl">{category.name}</h1>
              <p className="mt-4 max-w-2xl text-base leading-7 text-black/55 md:text-lg">{category.description}</p>
              <p className="mt-3 text-sm font-semibold text-black/45">{categoryTools.length} tools available</p>
            </div>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-4 border-t border-[#d8d4c9] pt-6 text-sm">
            <p className="text-black/50">All tools are free to use. No account is required.</p>
