...
import DocumentSimilarity from "@/components/tools/document-similarity";
...
const toolSeo: Record<string, ToolSeo> = {
  ...
  "developer-file-viewer": { title: "Developer File Viewer - Read Code & Project Files", description: "Open supported code, config, Markdown, JSON and text files locally in your browser with readable previews.", intro: "Choose a developer file to inspect its contents locally without uploading it.", uses: ["Read README and Markdown files", "Inspect JSON and configuration files", "Preview HTML and source code"] },
  "document-similarity-checker": { title: "Document Similarity Checker - Compare Two PDFs", description: "Compare two PDF documents for content, alignment, layout and visual similarity directly in your browser.", intro: "Choose two PDFs to compare their written content, page structure, text placement and rendered appearance without uploading the files.", uses: ["Check whether two PDFs contain similar content", "Compare text alignment and page layout", "Spot visual differences between document versions"] },
  "word-counter": { title: "Word Counter - Count Words & Reading Time", description: "Count words, characters, sentences and estimated reading time from text in your browser.", intro: "Paste text to get a quick breakdown of its length and estimated reading time.", uses: ["Count words in an article", "Check character limits", "Estimate reading time"] },
  "character-counter": { title: "Character Counter - Count Text Length", description: "Count characters with and without spaces, plus words and lines, directly in your browser.", intro: "Paste or type text to see its length and basic text statistics as you work.", uses: ["Check social media character limits", "Count characters in copy", "Measure text before submitting a form"] },
  "case-converter": { title: "Case Converter - UPPERCASE, lowercase & Title Case", description: "Convert text between common letter cases including uppercase, lowercase, title case and sentence case.", intro: "Paste text and switch its letter case with one click. Everything stays in your browser.", uses: ["Convert headings to title case", "Make text uppercase or lowercase", "Clean inconsistent capitalization"] },
  "text-cleaner": { title: "Text Cleaner - Clean & Normalize Text", description: "Clean extra spaces, blank lines and common text formatting noise in your browser.", intro: "Paste messy text and remove common formatting clutter with a few simple cleanup options.", uses: ["Remove extra spaces", "Normalize line breaks", "Clean copied text before reuse"] },
  "remove-duplicate-lines": { title: "Remove Duplicate Lines - Clean Lists", description: "Remove duplicate lines from text while preserving the first occurrence and the original order.", intro: "Paste a list or block of text to remove repeated non-empty lines locally.", uses: ["Clean repeated lists", "Deduplicate copied data", "Prepare unique line-based values"] },
  "url-slug-generator": { title: "URL Slug Generator - Create Clean Slugs", description: "Turn a title or phrase into a clean lowercase URL slug with simple separators.", intro: "Paste a page title to create a short, readable URL slug.", uses: ["Create blog URL slugs", "Clean page titles for URLs", "Normalize text for links"] },
  "text-diff-checker": { title: "Text Diff Checker - Compare Two Texts", description: "Compare two text blocks and highlight additions, removals and changes directly in your browser.", intro: "Paste the original and updated text to quickly see what changed.", uses: ["Compare document revisions", "Review copy changes", "Spot changed lines in text"] },
      ...
      <section className="container py-7 md:py-10 lg:py-12">
        <div className="mx-auto max-w-5xl">
          ...
          <section data-tool-workspace className="mt-9 overflow-hidden rounded-[24px] border border-[#d1cdc2] bg-[#fffdf8] shadow-[0_14px_36px_rgba(23,23,23,0.07)] md:mt-11" aria-labelledby="workspace-title">
            <div className="flex items-center justify-between gap-4 border-b border-[#e1ded5] bg-[#f8f5ed] px-4 py-3.5 md:px-5">
              <div className="min-w-0"><p id="workspace-title" className="text-sm font-black">Use the tool</p><p className="hidden text-xs text-black/40 sm:block">Enter what you need below. Your result stays on this page.</p></div>
