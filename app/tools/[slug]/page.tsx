...
const toolSeo: Record<string, ToolSeo> = {
  ...
  "document-similarity-checker": { title: "Document Similarity Checker - Compare Two PDFs", description: "Compare two PDF documents for content, alignment, layout and visual similarity directly in your browser.", intro: "Choose two PDFs to compare their written content, page structure, text placement and rendered appearance without uploading the files.", uses: ["Check whether two PDFs contain similar content", "Compare alignment, page sizes and text placement", "Spot documents that look visually alike"] },
