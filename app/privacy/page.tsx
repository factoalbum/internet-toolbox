  ...
  return (
    <main className="min-h-screen bg-[#f3f0e8] text-[#171717]">
      ...
      <article className="container py-14 md:py-20"><div className="mx-auto max-w-3xl space-y-10 text-base leading-8 text-black/60">
        ...
        <section><h2 className="text-2xl font-black text-[#171717]">Data retention</h2><p className="mt-3">Internet Toolbox does not intentionally retain the input you enter into browser-only tools on its servers. Results may remain temporarily in your browser while a page is open, and normal browser storage may remember site preferences. If a tool uses an external provider, that provider&apos;s own privacy policy and retention practices apply to the information included in the request.</p></section>
        ...
        <section><h2 className="text-2xl font-black text-[#171717]">Security and responsible use</h2><p className="mt-3">No online service can guarantee absolute security. Avoid entering sensitive information into a tool unless its page explicitly explains why the information is needed and how it is handled. Browser-only processing reduces unnecessary data transfer, but it does not make the device or browser itself secure.</p></section>
