...
export default function AllToolsBrowser() {
  ...
  return <div className="min-w-0">
    ...
    <div className="mt-6 flex items-center justify-between gap-3">
      ...
      {(query || category !== "all") && <button type="button" onClick={clearFilters} className="shrink-0 text-xs font-bold text-black/55 underline decoration-black/20 underline-offset-4 hover:text-black">Clear filters</button>}
    </div>
