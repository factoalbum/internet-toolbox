...
export default function AgeCalculator() {
  ...
  const isPristine = birth === "2000-01-01" && end === localDateValue();
  const reset = () => { setBirth("2000-01-01"); setEnd(localDateValue()); setCopied(false); setCopyError(false); };
