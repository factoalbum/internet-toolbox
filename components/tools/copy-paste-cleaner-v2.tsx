    ...
    <div className="overflow-hidden border border-[#d8d4c9] bg-[#fffdf8]">
      <div className="border-b border-[#d8d4c9] bg-[#e8e4d9] px-5 py-4 md:px-7">
        <div className="flex items-center justify-between gap-4">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0"><p className="font-bold">Make copied text ready to paste</p><p className="text-sm text-black/45">Remove Claude-style vertical markers, clean line endings and keep your wording unchanged.</p></div>
          </div>
      ...
      <div className="p-5 md:p-7">
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div>
            <div className="mb-2 flex items-center justify-between gap-3"><label htmlFor="copy-paste-cleaner-output" className="text-sm font-bold">Ready-to-paste text</label><button type="button" onClick={copyResult} disabled={!result} className="flex min-h-10 items-center gap-2 rounded-md border border-[#cfcabf] px-3 text-xs font-bold disabled:cursor-not-allowed disabled:opacity-35 hover:bg-[#f3f0e8] focus:outline-none focus:ring-4 focus:ring-[#c8f169]">{copied ? <Check size={15} aria-hidden="true" /> : <Clipboard size={15} aria-hidden="true" />}{copied ? "Copied" : "Copy"}</button></div>
        ...
        <div className="mt-4 rounded-xl border border-[#dedbd3] bg-[#faf9f6] px-4 py-3 text-xs leading-5 text-black/50"><strong className="text-black/70">Cleans:</strong> Claude-style ▎ line prefixes, common vertical quote markers, trailing spaces and excessive blank lines. It does not rewrite, summarize or change your words.</div>
