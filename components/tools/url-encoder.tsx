      ...
      <div className="border-b border-[#d8d4c9] bg-[#f4f1e9] px-5 py-4 md:px-7">
        <div className="flex items-start justify-between gap-4">
          <div className="flex min-w-0 items-center gap-3">
            <span className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-[#e6f2ff] text-[#35658f]" aria-hidden="true">
              <Link2 size={20} />
            </span>
            <div className="min-w-0">
              <p className="font-bold">Encode or decode URL text</p>
              <p className="text-sm leading-5 text-black/50">Convert spaces, symbols and other URL characters safely.</p>
            </div>
          </div>
          <button
            type="button"
      ...
      <div className="p-5 md:p-7">
        <section aria-labelledby="url-mode-label">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h3 id="url-mode-label" className="text-sm font-black">Choose an action</h3>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-2">
          <label className="block rounded-2xl border border-[#e2dfd7] bg-white p-4 transition focus-within:border-[#171717] focus-within:shadow-[0_0_0_4px_rgba(200,241,105,.28)]">
            <span className="flex items-center justify-between gap-3">
              <span className="text-sm font-bold">{mode === "encode" ? "Text or URL" : "Encoded URL text"}</span>
              <span className="text-[10px] font-black uppercase tracking-[.12em] text-black/35">Input</span>
            </span>
            ...
            <textarea
              ...
              className={`mt-3 min-h-56 w-full resize-y rounded-xl border border-[#bcb8ae] bg-[#fffdf8] p-4 font-mono text-sm leading-6 outline-none transition placeholder:text-black/30 focus:border-[#171717] ${focusRing}`}
            />
          ...
          <section className="rounded-2xl border border-[#d8d4c9] bg-[#f3f0e8] p-4" aria-labelledby="url-result-label" aria-live="polite" aria-atomic="true">
            <div className="flex items-center justify-between gap-3">
              <div>
                <h3 id="url-result-label" className="text-sm font-bold">Result</h3>
