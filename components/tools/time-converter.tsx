  ...
  return (
    <div className="border border-[#d8d4c9] bg-[#fffdf8]">
      <div className="border-b border-[#d8d4c9] bg-[#e8e4d9] px-5 py-4 md:px-7">
        ...
        <p className="mt-1 text-sm text-black/45">Convert seconds, minutes, hours and days.</p>
      </div>
      <div className="p-5 md:p-7">
        ...
        <div className="mt-5 border border-[#171717] bg-[#c8f169] p-5 md:p-6">
          ...
          <p className="mt-2 break-all text-2xl font-black tracking-tight md:text-3xl" aria-live="polite">{result === null ? "Enter a value" : `${formatNumber(result)} ${to}`}</p>
        </div>
