    ...
    <div className="border border-[#d8d4c9] bg-[#fffdf8] p-5 md:p-8">
      <div className="mb-5 flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-black/50">See your savings and final price instantly while shopping.</p>
        </div>
      ...
      <div className="mt-4">
        ...
        <div className="mt-2 flex flex-wrap gap-2" aria-label="Quick discount percentages">
      ...
      <p className="mt-5 border-t border-[#d8d4c9] pt-5 text-xs leading-5 text-black/45">Formula: savings = original price × discount ÷ 100. Sale price = original price − savings. Taxes, GST, fees or other charges may change the final amount a seller charges.</p>
    </div>
  );
}
